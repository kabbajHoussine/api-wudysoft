...
(async () => {
  ...
  try {
    ...
    const element = page.locator('.code-window');
    ...
    try {
      ...
      throw new Error(`Generation failed: ${typeof errorData === "object" ? JSON.stringify(errorData) : errorData}`);
    }
  }
}
